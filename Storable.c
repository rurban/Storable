...
XS(XS_Storable__Cxt_DESTROY)
{
    ...
    {
	SV *	self = ST(0);
#line 6397 "Storable.xs"
	stcxt_t *cxt = (stcxt_t *)SvPVX(SvRV(self));
#line 6471 "Storable.c"
#line 6399 "Storable.xs"
	if (kbuf)
		Safefree(kbuf);
...
XS(XS_Storable_dclone)
{
	...
	SV *	sv = ST(0);
	SV *	RETVAL;
#line 6498 "Storable.xs"
  RETVAL = dclone(aTHX_ sv);
#line 6621 "Storable.c"
	ST(0) = RETVAL;
	sv_2mortal(ST(0));
    }
    XSRETURN(1);
...
XS(XS_Storable_last_op_in_netorder)
{
    ...
    SP -= items;
    {
#line 6508 "Storable.xs"
  bool result;
#line 6645 "Storable.c"
#line 6510 "Storable.xs"
  if (ix) {
   dSTCXT;
